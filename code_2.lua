--[[ ============================================================================
  ...
  ПРАВКА (безопасность): УДАЛЕНЫ вкладка Weapon Spawn,
            тумблеры Kill All (Murder) и Wait in Lobby вместе с их логикой
            (в т.ч. спам Knife.Stab:FireServer). Остался только авто-фарм.
...
tabBtns["farm"] = farmTab
tabAccents["farm"] = farmAccent
